...
export const mockTasks: Task[] = [
  {
    ...
    type: 'design',
    assignee: 'Ana Silva',
    watchers: ['Carlos Mendes', 'Marina Costa'],
    squad: 'Design',
    clientId: '1',
    client: mockClients[0],
    projectId: '1',
  ...
  },
  {
    ...
    watchers: ['Ana Silva', 'Sofia Rodrigues'],
    squad: 'Conteúdo',
    clientId: '1',
    client: mockClients[0],
    projectId: '1',
  ...
  },
  {
    ...
    watchers: ['Sofia Rodrigues', 'Maria Oliveira'],
    squad: 'Conteúdo',
    clientId: '2',
    client: mockClients[1],
    dueDate: '2024-11-30',
