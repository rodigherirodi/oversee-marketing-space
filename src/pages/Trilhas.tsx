...
const Trilhas = () => {
  ...
  const { trilhas, userProgress } = useTrilhas();
  ...
  return (
    <div className="space-y-6">
      ...
      {Object.entries(trilhasPorCategoria).map(([categoria, trilhasCategoria]) => (
            ...
            {trilhasCategoria.map((trilha) => {
              ...
              return (
                <Card 
                  ...
                  onClick={() => handleTrilhaClick(trilha.id)}
                >
                  <CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {trilha.tags.slice(0, 3).map((tag, index) => (
