          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex justify-between py-[38px]">
                  <span className="text-sm text-gray-500 py-[9px]">Porte:</span>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium">{client.financialContact.name}</p>
                      <p className="text-sm text-gray-600 py-[21px]">Gerente Financeiro</p>
                    </div>
