...
import { Plus, Grid, List, Search, Filter, Users, Building, TrendingUp, X, UserPlus, Flame, Heart } from 'lucide-react';
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="border-b border-gray-200">
                <nav className="flex space-x-8">
                  ...
                  >
                    Ativos ({filteredClients.filter(c => c.status === 'active').length})
                  </button>
                  <button
                      ...
                      >
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex justify-between text-sm text-gray-600">
                            <span>{stats.projectCount} projetos</span>
            ...
            <div className="space-y-4">
              <div className="bg-orange-50 rounded-lg p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">Produtividade</p>
              ...
              <div className="bg-red-50 rounded-lg p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">Satisfação</p>
